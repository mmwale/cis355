...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const books = yield index_1.Book.findAll({
            include: [
                { model: index_1.Author, as: 'author' },
                { model: index_1.Category, as: 'categories' }
            ]
        });
...
router.get('/new', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const authors = yield index_1.Author.findAll();
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const book = yield index_1.Book.create({
            title,
...
router.get('/:id/edit', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const book = yield index_1.Book.findByPk(bookId, {
            include: [
                { model: index_1.Author, as: 'author' },
                { model: index_1.Category, as: 'categories' }
            ]
...
router.post('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let categories = [];
        if (parsedCategoryIds.length > 0) {
            categories = yield index_1.Category.findAll({
                where: {
                    id: parsedCategoryIds
                }
            });
